...
(function () {
  const COPY = {
    en: {
      ...
      "rules.hardcore_agents": "The AIs play as one side against you. Eliminating a human costs them nothing, and each of them wins simply by being alive at the end. They have every reason to vote you out, and they have been told so.",
    ...
    fr: {
      ...
      "rules.hardcore_agents": "Les IA jouent ensemble contre vous. Éliminer un humain ne leur coûte rien, et chacune gagne simplement en étant en vie à la fin. Elles ont donc tout intérêt à vous sortir, et on le leur a dit.",
