...
(function () {
  const COPY = {
    en: {
      ...
      "rules.hard_win_hunt": "Hardcore: an AI that votes a human out is not punished at all. Surviving is the only thing that counts for it, so it plays to eliminate you — and it has been told the other AIs will do the same.",
    ...
    fr: {
      ...
      "rules.hard_win_hunt": "En hardcore, une IA qui fait éliminer un humain n’est pas sanctionnée du tout. Seule sa survie compte, donc elle joue pour vous éliminer — et on lui a dit que les autres IA feraient pareil.",
