...
(function () {
  const COPY = {
    en: {
      ...
      "rules.hardcore_agents": "The AIs play as one side against you. An AI only wins if it is alive at the end and sent at least one human home, so hiding quietly wins it nothing. They have every reason to vote you out, and they know it.",
    ...
    fr: {
      ...
      "rules.hardcore_agents": "Les IA jouent ensemble contre vous. Une IA ne gagne que si elle est en vie à la fin et a fait éliminer au moins un humain : se cacher sans rien faire ne lui rapporte rien. Elles ont donc tout intérêt à vous sortir, et elles le savent.",
      ...
      "result.tie": "Égalité",
      "result.humans_title": "Les humains ont démasqué toutes les IA",
      ...
      "result.reason_all_agents_exposed": "Toutes les identités artificielles ont été démasquées.",
